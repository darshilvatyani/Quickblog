...
const Blog = () => {
  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='mt-14 mb-10 max-w-3xl mx-auto'>
        ...
        <div className='flex flex-col gap-4'>{comments.map((item,index) =>(
  ...
  <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
    ...
    <textarea input onChange= {(e) => setContent(e.target.value)} value = {content} placeholder='Comment' id="" className='w-full p-2 border border-gray-300 rounded outline-none h-48' required></textarea>
